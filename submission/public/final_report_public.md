...
![System architecture and data flow](figures/fig01_architecture_pipeline.png)
...
![OpenMP speedup across TSPLIB95 instances](figures/fig02_openmp_speedup.png)

图 2：OpenMP 多实例加速比。

![OpenMP parallel efficiency across TSPLIB95 instances](figures/fig03_openmp_efficiency.png)
...
![Default-parameter Gap comparison](figures/fig04_default_gap.png)
...
![Gap reduction after tuning and targeted enhancement](figures/fig05_tuning_curve.png)
...
![QLSA policy comparison](figures/fig06_policy_comparison.png)
...
![CUDA positioning on berlin52](figures/fig07_cuda_positioning.png)
...
![Runtime reference comparison with the paper](figures/fig08_paper_runtime_comparison.png)
...
![Hard-instance mean Gap comparison](figures/fig09_paper_quality_comparison.png)
...
本课程大作业为单人团队完成，团队成员信息已脱敏。因此，从选题、论文阅读、工程实现、并行化设计、实验执行、结果分析到报告撰写，均由本人独立承担。
