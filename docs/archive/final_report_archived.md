...
![系统架构与数据流](../../figures/final/fig_architecture_pipeline.png)
...
![OpenMP 多实例加速比](../../figures/final/fig_openmp_speedup.png)
...
![OpenMP 并行效率](../../figures/final/fig_openmp_efficiency.png)

图 3  OpenMP 并行效率。并行效率低于理想值，但在随机启发式搜索任务中仍具有稳定收益。

![OpenMP 线程扩展性](../../figures/final/fig_openmp_scaling_threads.png)

图 4  OpenMP 线程扩展性。线程数从 1 增加到 16 时 speedup 继续上升，但逐渐偏离理想线性加速。

### 6.2 解质量结果

![默认参数 Gap 对比](../../figures/final/fig_gap_comparison.png)
...
![调优与定向增强 Gap](../../figures/final/fig_tuning_curve.png)
...
![QLSA 策略对比](../../figures/final/fig_policy_comparison.png)
...
![CUDA 定位](../../figures/final/fig_cuda_positioning.png)
...
![论文与本实现运行时间对比](../../figures/final/fig_paper_runtime_comparison_log.png)
...
![论文 hard-instance 解质量对比](../../figures/final/fig_paper_quality_hard_instances.png)
